...
public strictfp class S1AngleTest extends TestCase {
  ...
  public void testNormalize() {
    ...
    // Should wrap around.
    assertEquals(-Math.PI, S1Angle.radians(Platform.nextAfter(Math.PI, 4.0)).normalize().radians(),
        EPSILON);
    assertEquals(Math.PI, S1Angle.radians(Platform.nextAfter(Math.PI, 0.0)).normalize().radians(),
        EPSILON);

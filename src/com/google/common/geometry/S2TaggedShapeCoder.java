...
public class S2TaggedShapeCoder implements S2Coder<S2Shape> {
   ...
   *
   * <p>WARNING: The compact encodings of {@link S2Point.Shape}, {@link S2LaxPolygonShape}, and
   * {@link S2LaxPolylineShape} are not enabled by default in C++. Attempting to read shapes encoded
   * by this coder in C++ without explicitly enabling the compact shape format may cause your code
   * to error.
   */

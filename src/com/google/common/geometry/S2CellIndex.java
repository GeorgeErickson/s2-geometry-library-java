 ...
 *
 * <p>>Internally, the index consists of a set of non-overlapping leaf cell ranges that subdivide
 * the sphere and such that each range intersects a particular set of (cellId, label) pairs. Data
 * is accessed using the following iterator types:
 *
 * <ul>
...
public class S2CellIndex {
  ...
  public class RangeIterator {
    ...
    /**
     * Positions the iterator at the first range with startId() >= target. Such an entry always
     * exists as long as "target" is a valid leaf cell.
     *
